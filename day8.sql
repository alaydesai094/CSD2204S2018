...
MariaDB [csd2204s18]> drop ac_
    -> ;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'ac_' at line 1
MariaDB [csd2204s18]> drop ac_master;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'ac_master' at line 1
MariaDB [csd2204s18]> drop table ac_master;
...
MariaDB [csd2204s18]> select count(*), manufacturer
    -> from products p inner join manu m
...
MariaDB [csd2204s18]> select manufacturer,count(*)"no.of items in products", m.name, 
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer
    ->     group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from products p inner join manu m
    on m.code = p.manufacturer
    group by ma' at line 2
MariaDB [csd2204s18]> select manufacturer,count(*)"no.of items in products", m.name 
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer
    ->     group by manufacturer;
+--------------+-------------------------+-------------------+
| manufacturer | no.of items in products | name              |
+--------------+-------------------------+-------------------+
|            1 |                       1 | Sony              |
|            2 |                       3 | Creative Labs     |
|            3 |                       2 | Hewlett-Packard   |
...
MariaDB [csd2204s18]> select manufacturer,count(*)"no.of items in products", m.name 
    ...
    ->     on m.code = p.manufacturer
    ->     from products p inner join manu m;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from products p inner join manu m' at line 4
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer m.code < 4  
    ->     group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'm.code < 4  
    group by manufacturer' at line 3
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where m.code < 4  
    ->     group by manufacturer;
+--------------+-----------------+-------------------------+
| manufacturer | name            | no.of items in products |
+--------------+-----------------+-------------------------+
|            1 | Sony            |                       1 |
|            2 | Creative Labs   |                       3 |
|            3 | Hewlett-Packard |                       2 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where m.code > 2  
    ->     group by manufacturer;
+--------------+-------------------+-------------------------+
| manufacturer | name              | no.of items in products |
+--------------+-------------------+-------------------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where Count(*) > 2  
    ->     group by manufacturer;
ERROR 1111 (HY000): Invalid use of group function
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products" as c
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where c > 2  
    ->     group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'as c
    from products p inner join manu m
    on m.code = p.manufacturer where ' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products" c
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where c > 2  
    ->     group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'c
    from products p inner join manu m
    on m.code = p.manufacturer where c >' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer  
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer  
    ->     group by manufacturer having m.code ='2' or m.code ='3';
ERROR 1054 (42S22): Unknown column 'm.code' in 'having clause'
MariaDB [csd2204s18]> select manufacturer, m.name, count(*)"no.of items in products"
    ->     from products p inner join manu m
    ->     on m.code = p.manufacturer where m.code ='2' or m.code ='3' 
    ->     group by manufacturer ;
+--------------+-----------------+-------------------------+
| manufacturer | name            | no.of items in products |
+--------------+-----------------+-------------------------+
...
MariaDB [csd2204s18]> select products.code, products.name, manu.name from left join products on products.code = manu.code;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'left join products on products.code = manu.code' at line 1
...
select products.code, products.name, manu.name
 from products right join m' at line 1
MariaDB [csd2204s18]> select products.code, products.name, manu.name
    ->  from products left join manu
    ->  on products.code = manu.code;
+------+-----------------+-------------------+
